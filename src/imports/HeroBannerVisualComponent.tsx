import svgPaths from "./svg-u6qv8mk78o";

function Group() {
  return (
    <div className="h-[512.056px] relative w-[366.975px]">
...
function Group4() {
  return (
    <div className="absolute contents left-0 top-0">
      <div className="absolute flex items-center justify-center left-[48.1px] size-[479.344px] top-[23px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "0" } as React.CSSProperties}>
        <div className="flex-none rotate-[20.66deg]">
          <div className="border-3 border-[#e13d21] border-solid rounded-[10px] size-[372px]" />
        </div>
      </div>
      <div className="absolute flex h-[610.109px] items-center justify-center left-0 top-0 w-[628.191px]" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-[50.06deg]">
          <Group />
        </div>
      </div>
    </div>
...
function ChineseKnotVisualIllustration() {
  return (
...
export default function HeroBannerVisualComponent() {
  return (
